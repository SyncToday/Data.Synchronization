...
let project = "SyncToday.Data.Synchronization"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "Data Synchronization Core"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Data Synchronization Core"

// List of author names (for NuGet package)
let authors = [ "davidpodhola" ]

// Tags for your project (for NuGet package)
let tags = "synchronization sync data"

// File system information
let solutionFile  = "SyncToday.Data.Synchronization.sln"
...
let gitName = "Data.Synchronization"
...
Target "Fable" (fun _ ->
  ...
  let fablePath = 
    if File.Exists("../Fable/build/fable/index.js") then
      ...
      cd ../../../../
      *)
      Util.run "paket-files/js/fsprojects/Fable" (if EnvironmentHelper.isUnix then "bash" else "build.cmd") (if EnvironmentHelper.isUnix then "build.sh" else "")
